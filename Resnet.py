...
# Model Save Paths
BASE_MODEL_PATH = 'resnet50_base_model.keras'
FINE_TUNED_MODEL_PATH = 'resnet50_fine_tuned_model.keras'
...
def create_resnet50_model(input_shape, n_classes, optimizer, fine_tune=0):
...
if os.path.exists(BASE_MODEL_PATH):
    ...
    model = create_resnet50_model(INPUT_SHAPE, N_CLASSES, optimizer_base, fine_tune=0)
...
if os.path.exists(FINE_TUNED_MODEL_PATH):
    ...
    model = create_resnet50_model(INPUT_SHAPE, N_CLASSES, optimizer_ft, fine_tune=4)  # Unfreeze top 4 layers
