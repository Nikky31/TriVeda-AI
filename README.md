...
<p align="center">
  ...
  <a href="#-target-botanical-species">Botanicals</a> •
  ...
  <a href="#-complete-project-structure">Project Structure</a> •
...
```text
              [ Raw Dried Specimen ]
                        ...
                        ▼
         ┌─────────────────────────────┐
         │ Real-time Vision Transforms │
         │ (Affine, Zoom, Color Shift) │
         └──────────────┬──────────────┘
                        │
                        ▼
         ┌─────────────────────────────┐
         │ Paired Residual Conv Blocks │ ──► [ Global Average Pooling ]
         └──────────────┬──────────────┘                │
                        │                               ▼
                        └─────────────────────► [ Multi-Class Softmax ]
                                                        │
...
├── VGG19.py                        # VGG19 Transfer Learning Script
...
<details>
<summary><b>🔍 Expand UML Diagram Commands</b></summary>
